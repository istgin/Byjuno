    ...
    public function isAvailable($quote = null)
    {
        if (Mage::app()->getStore()->isAdmin())
        {
            ...
            if ($is_b2b && $quote->getBillingAddress()->getCompany() != "") {
                $payments = Mage::getStoreConfig('payment/cdp/byjuno_invoice_paymentsb2b', $quote->getStore());
            } else {
                $payments = Mage::getStoreConfig('payment/cdp/byjuno_invoice_payments', $quote->getStore());
            }
            $active = false;
